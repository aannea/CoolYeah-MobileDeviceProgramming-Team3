...
class LaporanEmosional extends StatefulWidget {
  String? laporanId;
  final String muridId;

  LaporanEmosional({this.laporanId, required this.muridId});

  @override
  _LaporanEmosionalState createState() => _LaporanEmosionalState();
}

class _LaporanEmosionalState extends State<LaporanEmosional> {
  ...
  Future<void> _loadExistingLaporan() async {
    try {
      ...
      if (laporan != null) {
        setState(() {
          _deskripsiController.text = laporan.emosiDeskripsi ?? '';
          _rekomendasiController.text = laporan.emosiRekomendasi ?? '';
          _selectedGrade = laporan.nilaiAnakEmosi;
        });
      }
    } catch (e) {
      ...
      try {
        if (widget.laporanId == null) {
          await _service.createLaporanAkademik(
            ...
            emosiDeskripsi: _deskripsiController.text,
            emosiRekomendasi: _rekomendasiController.text,
            nilaiAnakEmosi: _selectedGrade,
          );
        } else {
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Deskripsikan Perkembangan Emosional Anak',
